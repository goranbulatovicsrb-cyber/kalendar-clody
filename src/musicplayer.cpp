...
void MusicPlayer::setupUI() {
    ...
    m_playlistWidget->setMinimumHeight(100);
    m_playlistWidget->setMaximumHeight(200);
    m_playlistWidget->setStyleSheet(
        "QListWidget { background:#070718; border:1px solid rgba(153,102,204,0.25); border-radius:6px; color:#ddddf5; font-size:12px; }"
        "QListWidget::item { padding:5px 8px; color:#ddddf5; }"
        "QListWidget::item:hover { background:rgba(153,102,204,0.2); color:#ffffff; }"
        "QListWidget::item:selected { background:rgba(233,69,96,0.3); color:#ffffff; font-weight:600; }");
